...
<head>
    ...
    <style>
        ...
        h1 {
            color:rgb(43, 126, 47);; /* Groene kleur voor de titel */
        }
        ...
        .logout-btn {
            ...
            padding: 10px 20px;
            border: none;
            z-index: 1000; /* Zorg dat de knop altijd boven andere elementen staat */
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="container">
        ...
        <a href="old_reserveringen.php" class="btn btn-back">Alle reserveringen</a>
        </div>
    </div>
